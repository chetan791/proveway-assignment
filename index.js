...
unit_container.innerHTML = arr
  .map((el, i) => {
    ...
    ${
      i == 1
        ? `<div
          style="background-color: #ff6b82;text-align: center ; color: white; border-bottom-left-radius: 4px;
      border-radius: 4px;width: 119px;font-size: 12px;height: 26px ;display: flex;align-items: center;justify-content: center ;font-weight: 700 ; position: absolute; right: 5px; top: -10px;"
        >
          <p>MOST POPULAR</p>
        </div>`
        : ""
